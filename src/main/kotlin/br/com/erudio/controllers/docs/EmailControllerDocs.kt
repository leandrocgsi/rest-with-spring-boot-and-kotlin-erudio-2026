...
interface EmailControllerDocs {
    ...
    fun sendEmail(emailRequest: EmailRequestDTO): ResponseEntity<String>
    ...
    fun sendEmailWithAttachment(emailRequest: String, attachment: MultipartFile): ResponseEntity<String>
}
